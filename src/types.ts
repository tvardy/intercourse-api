...
declare function DefaultJsonHandler(res: SomeResponse | KoaResponse, { status, message }: DefaultJSON): void

// declare function DefaultEmptyHandler(res: KoaResponse, status: number): void
declare function DefaultEmptyHandler(res: SomeResponse | KoaResponse, status: number): void

export type Query = ParsedQs | ParsedUrlQuery | undefined
export type PassThroughHandler = (jsonFn: typeof DefaultJsonHandler, endFn: typeof DefaultEmptyHandler, options?: AnyObject) => SomeHandler | Application.Middleware
